...
function Customize2() {
    ...
    return (
        <div className="w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] relative">
          <MdKeyboardBackspace className='absolute top-[25px] left-[25px] text-white cursor-pointer w-[25px] h-[25px]' onClick={() => navigate(("/customize"))}/>
            ...
            <input
                ...
                className="w-full max-w-[600px] h-[60px] outline-none border-2 border-white bg-transparent text-white placeholder-gray-300 px-[20px] py-[10px] 
